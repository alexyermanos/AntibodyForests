...
### Synchronize node names of AntibodyForests objects with the `Af_sync_nodes()` function
...
<br>
To achieve this, the Af_sync_nodes() function can be used. This function takes one AntibodyForests object as a reference and renames the nodes of all clonotypes within all samples of another AntibodyForests object to match the reference. The function matches the nodes using barcodes.  
<br>
