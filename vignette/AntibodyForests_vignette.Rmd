...
* **Example:** `"/directory/lineage_tree.png"`  
* **Default:** `NULL`   
<br>
</div>
...
![](imgs/main/Pseudolikelihood.png)
...
* **Description:** The path to the directory containing the PDB files of the sequences in the VDJ dataframe and AntibodyForests object.
* **Example:** `/path/to/pdb/`  
* **Default:** *None*  
<br>
...
* **Description:** Specifies the colors to be used in the plot.
* **Example:** `"red"`
* **Default:** `"black"`
<br>
...
* **Description:**  Specifies the size of the points for the scatterplot. 
* **Example:** `3`
* **Default:** `1`  
<br>
...
```{r, structure_example1_plot, eval = T}
...
```{r, structure_example2_plot, eval = T}
...
```{r, structure_example3_plot, eval = T}
...
```{r, structure_example4_plot, eval = T}
...
rmsd_df <- Af_edge_RMSD(af,
             ...
             chain = "HC+LC")
```
![](imgs/structure_Ab_distance.png)
...
rmsd_df <- Af_edge_RMSD(af,
             ...
             chain = "whole.complex")
```
![](imgs/structure_AbAg_distance.png)
